        ...
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
              Identifying innovative enterprising solutions 
            </Heading>
            <Text as="p" sx={styles.text}>
            Small and medium enterprises (SME) are notably the engines that drive economic development. However, in Africa besides their critical and positive role, many SMEs face numerous challenges. 
            </Text>
